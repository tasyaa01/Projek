     ...
     <?php }elseif($destinasi == "7"){ ?>
              ...
              <div class="cafe">
                    <select name="pilih">
                        ...
                        <option value="1">Gudeg</option>
                        <option value="2">Oseng Mercon</option>
                        <option value="3">Bakpia Pathuk</option>
                        <option value="4">Air Mineral</option>
                        <option value="5">Wedang uwuh</option>
                        <option value="6">Kopi Jos</option>
                    </select>
